...
import FeedbackForm from '../components/kontak/FeedbackForm';
    ...
    <>
      <Layout>
        <div className="bg-white dark:bg-gray-900">
          <div className="ubuntu-font text-[#444B55] dark:text-white flex md:container md:mx-auto justify-between lg:px-40">
