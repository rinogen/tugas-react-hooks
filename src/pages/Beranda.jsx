    ...
    <>
      <Layout>
        <div className="flex flex-col md:mx-auto">
          <section className="relative flex z-10 items-start w-full h-full md:h-[380px] lg:h-[472px] xl:h-[472px] overflow-hidden bg-gradient-to-r from-[#D6FCFF] to-[#29BBD4]">
